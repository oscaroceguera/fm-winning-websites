...
function Animation() {
    ...
    () => {
      const tl = gsap.timeline({
        scrollTrigger: {
          ...
          //pin: true, // sticky
          pin: ".pinned",
          //scrub: true, // animation exactly follow my progress
          scrub: 1, // animation exactly scroll
          start: "top top",
          end: "bottom bottom",
        },
      });
  ...
  return (
    ...
    >
      <div className="pinned flex h-screen justify-center items-center border border-red-600">
